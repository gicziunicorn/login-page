<nav>
    <div id="bal">
        <a href="https://github.com/gicziunicorn/login-page/tree/main" title="Visit our github page">
    ...
    <div id="jobb">
        ...
        <a href="index.php" id="settings" class="<?php echo isset($_SESSION['userid'])?'':'hidden'; ?>">
            <div id="setdiv">
